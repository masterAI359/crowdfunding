    ...
    const menuItems = [
        {
            ...
            icon: (
                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.5 3.16602H15.8333V7.91602H9.5V3.16602ZM9.5 16.6243V8.70768H15.8333V16.6243H9.5ZM2.375 16.6243V11.8743H8.70833V16.6243H2.375ZM2.375 11.0827V3.16602H8.70833V11.0827H2.375ZM3.16667 3.95768V10.291H7.91667V3.95768H3.16667ZM10.2917 3.95768V7.12435H15.0417V3.95768H10.2917ZM10.2917 9.49935V15.8327H15.0417V9.49935H10.2917ZM3.16667 12.666V15.8327H7.91667V12.666H3.16667Z" fill="black" stroke="black" stroke-width="0.2" />
                </svg>
        ...
        },
        {
            ...
            icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.0002 1.125L16.8002 5.025V14.775L9.0002 18.6656L1.2002 14.775V5.025L9.0002 1.125ZM14.8596 5.4L9.0002 2.475L6.74082 3.6L12.5627 6.54375L14.8596 5.4ZM9.0002 8.325L11.2314 7.21875L5.4002 4.275L3.14082 5.4L9.0002 8.325ZM2.4002 6.375V14.025L8.4002 17.025V9.375L2.4002 6.375ZM9.6002 17.025L15.6002 14.025V6.375L9.6002 9.375V17.025Z" fill="black" />
                </svg>

            ),
            children: [
                { id: "crowdfunding", label: "クラウドファンディング", href: "/admin/products/crowdfunding" },
        ...
        },
        {
            ...
            icon: (
                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.9603 1.51953H2.28027V16.7195H15.9603V1.51953Z" stroke="black" stroke-width="1.14" />
                    <path d="M2.28027 15.1563L6.37135 11.9217L13.181 16.7188M9.32471 3.79883H4.55951M13.6803 6.34027H4.56027M15.9603 8.78671H2.28027M12.6581 10.7581C12.9917 10.7581 13.3116 10.8907 13.5475 11.1265C13.7834 11.3624 13.9159 11.6824 13.9159 12.0159C13.9159 12.3495 13.7834 12.6695 13.5475 12.9053C13.3116 13.1412 12.9917 13.2737 12.6581 13.2737C12.3245 13.2737 12.0046 13.1412 11.7687 12.9053C11.5328 12.6695 11.4003 12.3495 11.4003 12.0159C11.4003 11.6824 11.5328 11.3624 11.7687 11.1265C12.0046 10.8907 12.3245 10.7581 12.6581 10.7581Z" stroke="black" stroke-width="1.14" />
                </svg>

            ),
            children: [
                { id: "management", label: "管理画面", href: "/admin/website/management" },
            ],
        },
        {
            id: "contacts",
                                ...
                                if (item.type === "single") {
                                    ...
                                    return (
                                        <Link
                                            key={item.id}
                                            href={item.href}
                                            className={`flex font-bold font-weight-[700] text-[16px] items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive
                                    ...
                                    return (
                                        <div key={item.id}>
                                            <button
                                                ...
                                                className={`w-full font-bold flex items-center justify-between px-4 py-3 rounded-lg text-sm transition-colors ${pathname.startsWith(`/admin/${item.id}`)
                                                    ...
                                                    {item.children.map((child) => {
                                                        ...
                                                        return (
                                                            <Link
                                                                key={child.id}
                                                                href={child.href}
                                                                className={`block px-4 py-2 rounded-lg text-sm transition-colors ${isChildActive
                                                                    ? "bg-[#FF0066] text-white"
