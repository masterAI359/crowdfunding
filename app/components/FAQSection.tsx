import {
  ...
  const faqs = [
    ...
    {
      question: "動画はどのデバイスで？",
      answer: "スマートフォン、タブレット、パソコンなど、インターネットに接続できるデバイスでご視聴いただけます。",
    },
    {
    ...
    return (
              <section className="bg-[#FF0066] py-12 px-4 md:py-16">
                <div className="container mx-auto max-w-2xl">
                  ...
                  <p className="text-center text-white/90 text-sm md:text-base mb-8 px-2">
                  ...
                  <Accordion type="single" collapsible className="space-y-3 md:space-y-4">
                    {faqs.map((faq, index) => (
                      <AccordionItem
                        key={index}
                        value={`item-${index}`}
                        className="bg-white rounded-full px-5 md:px-6 border-0"
                      >
