        ...
        <section className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-12 gap-6 md:gap-8">
            ...
            <div className="space-y-4 md:space-y-6 lg:ml-4">
              <div>
                <h2 className="text-sm md:text-md text-black font-bold mb-2 md:mb-4">
                  現在の支援総額
                </h2>
                <p className="text-3xl md:text-4xl lg:text-7xl font-bold text-gray-900">
                  {project.amount}
                </p>
              </div>
              ...
              <div className="grid grid-rows-2 gap-3 md:gap-4 lg:gap-8">
                <div>
                  ...
                  <p className="text-2xl md:text-3xl lg:text-6xl text-black font-bold">
                    {project.supporters}
                  </p>
                </div>
                <div>
