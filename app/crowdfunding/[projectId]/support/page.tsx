...
const SupportPage = ({ params: paramsPromise }: { params: Promise<{ projectId: string }> }) => {
  ...
  const handlePurchase = () => {
    ...
    try {
      ...
      router.push(
        `/crowdfunding/checkout?projectId=${params.projectId}&returnIds=${rewardIds}&quantities=${quantitiesStr}`
      )
    } catch (error) {
        ...
        <div className="max-w-5xl mx-auto space-y-6 mb-6 sm:mb-8">
          {returns
            ...
            .map((returnItem) => {
              ...
              return (
                <div key={returnItem.id} className="bg-white border border-[#E9E9E9] rounded-lg">
                  <div className="bg-[#ECEBD9] px-3 sm:px-4 py-2 rounded-t-lg border-b border-gray-300">
                    <h3 className="font-bold text-lg sm:text-xl text-black">{returnItem.title}</h3>
                  </div>
                    ...
                    <div className="flex flex-col space-y-3 sm:space-y-4 md:col-span-2">
                      <div className="flex items-center gap-3 sm:gap-4 md:ml-10">
                        ...
                        <div className="flex items-center justify-between bg-[#F4F3E5] rounded-sm md:pl-6 px-2 py-1 w-fit ml-auto md:mr-[10vw]">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              handleQuantityChange(returnItem.id, parseInt(e.target.value))
                            }
                      ...
                      {isOutOfStock && (
                        <div className="md:mx-10">
                          <p className="text-sm text-red-600 font-medium">在庫がありません</p>
                        </div>
                      )}
                      ...
                      {returnItem.stock !== null &&
                        ...
                        returnItem.stock > 0 && (
                          <div className="md:mx-10">
                            <p className="text-xs text-gray-500">在庫: {returnItem.stock}個</p>
                          </div>
                        )}
