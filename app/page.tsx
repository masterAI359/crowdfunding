          ...
          <div className="z-10 flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div className="grid mb-[147px] sm:grid-cols-2 grid-cols-1 gap-4 justify-center items-center mx-auto px-6 sm:px-10 font-semibold text-md md:mb-[140px]">
              ...
              >
                ...
                >
                  <path
                    d="M10.8 4.92016C12 5.61298 12 7.34503 10.8 8.03785L2.7 12.7144C1.5 13.4072 0 12.5412 0 11.1555V1.80246C0 0.416823 1.5 -0.449199 2.7 0.243621L10.8 4.92016Z"
                    fill="white"
                  />
                </svg>
              </Link>
