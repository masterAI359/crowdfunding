            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex flex-col gap-4 bg-[#ECEBD9] p-4 rounded-lg">
                            {relatedVideos.filter(v => v.id !== videoId).slice(0, 6).map((relatedVideo) => (
                                <Link
                                    key={relatedVideo.id}
                                    ...
                                    <div className="flex-1 p-6 bg-white relative">
                                        ...
                                        <div className="text-sm text-gray-700 leading-relaxed max-w-full">
                                            <p className="line-clamp-3 break-words text-wrap max-w-full">
                                                {relatedVideo.description || "この文章はダミーですこの文章はダミーですこの文章はダミーですこの文章はダミーですこの文章はダミーですこの文章はダミーですこの文章はダミーですこの文章はダミーですこの文章はダミーです"}
                                            </p>
                                        </div>
                                    </div>
                                </Link>
                        ...
                        <div className=" border border-gray-200 rounded-lg p-6 mb-6">
                            ...
                            {video.owner && (
                                <div className="flex items-center justify-between mb-2 pb-2">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-semibold text-gray-900">{video.owner.name || "Meat Dept."}</p>
                                        </div>
                                    </div>
                            ...
                            {video.description && (
                                <div className="mb-2 pb-2">
                                    <p className="text-gray-700 whitespace-pre-wrap leading-relaxed break-words">{video.description}</p>
                                </div>
                            )}
                ...
                <div className="w-full mt-6 rounded-lg p-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {relatedVideos.filter(v => v.id !== videoId).slice(0, 4).map((popularVideo, index) => (
                            <Link
                                key={popularVideo.id}
                                ...
                                <div className="bg-white rounded-lg overflow-hidden shadow hover:shadow-lg transition-shadow">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex items-center text-xs text-gray-500 gap-1">
                                            <span>視聴回数：{popularVideo.viewCount?.toLocaleString() || '150,000'}</span>
                                            <span>•</span>
