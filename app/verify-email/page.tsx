    ...
    <div className="min-h-screen bg-white flex items-center justify-center py-12 px-6 lg:px-8 pt-28">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">受信ボックスを確認</h2>
          <p className="text-md text-black leading-relaxed font-semibold">
            登録を完了するには、 <span className="font-medium text-gray-900">{email}</span>{' '}
        ...
        <div className="text-center">
          <p className="text-md text-black leading-relaxed font-semibold inline-flex">
            コードを受け取っていませんか?{' '}
            {resendCountdown > 0 ? (
              <span className="text-gray-500">コードを再送信{resendCountdown}</span>
            ) : (
              <button
                type="button"
